class TmuxAgents < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/piacsek/tmux-agents/releases/download/v#{version}/tmux-agents-aarch64-apple-darwin.tar.gz"
      sha256 "63e369a6b4663275332ed645d777c2682cf96c47df57c15c109092436efc975a"
    end
    on_intel do
      url "https://github.com/piacsek/tmux-agents/releases/download/v#{version}/tmux-agents-x86_64-apple-darwin.tar.gz"
      sha256 "839d8b77d25b2e562de4eddfef5bc2a55d56bacf4d35912636304f5d6317ee40"
    end
  end

  on_linux do
    url "https://github.com/piacsek/tmux-agents/releases/download/v#{version}/tmux-agents-x86_64-unknown-linux-gnu.tar.gz"
